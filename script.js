...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const portfolioInfo = {
        ...
        education: {
            bsc: {
                ...
                period: "2022 - 2025",
                percentage: "77.7%",
                details: "Successfully completed my Bachelor's degree with a focus on computer science fundamentals, programming languages, and modern web application development."
            },
            hsc: {
        ...
        skills: {
            ...
            php: {
                ...
                proficiency: "75%",
                level: "Intermediate",
                description: "Proficient in server-side scripting with PHP, building dynamic web content and integrating with databases like MySQL."
            },
            bootstrap: {
                name: "Bootstrap",
                proficiency: "85%",
                level: "Advanced",
                description: "Expert in using Bootstrap for responsive, mobile-first web development with custom themes and components."
            },
            wordpress: {
                name: "WordPress",
                proficiency: "80%",
                level: "Advanced",
                description: "Experienced in WordPress development, including theme customization, plugin integration, and CMS management."
            },
            react: {
                name: "React",
                proficiency: "82%",
                level: "Advanced",
                description: "Skilled in building interactive and reusable UI components with React.js, hooks, and modern front-end workflows."
            }
        },
        projects: {
            foodDelivery: {
                ...
                description: "A comprehensive full-stack food delivery application built using Java and Spring Boot.",
                link: "https://www.linkedin.com/posts/moneshwar-s-s-066441334_hardworkpaysoff-fullstackdeveloper-javadeveloper-activity-7359847704216104961-087o?utm_source=share&utm_medium=member_desktop&rcm=ACoAAFQR-w4Bb10SMnPKmC2wN18Jl4khzpLzIbM"
            },
            netflixClone: {
                name: "Netflix Clone",
                technologies: ["React", "Firebase", "TMDB API"],
                description: "A high-fidelity Netflix clone developed with React.js.",
                link: "https://lnkd.in/gRFqWyGF"
            },
            selfParking: {
    ...
    function getAIResponse(userMessage) {
        ...
        // Introduction/Personal Information
            ...
            return `Hello! I'm Monesh AI Assistant, representing Moneshwar S S, a Web Developer. I'm here to tell you about Moneshwar's skills in PHP, Bootstrap, WordPress, React, Java, and his projects like the Food Delivery App and Netflix Clone. Moneshwar is a graduate with a BSc in Computer Science from SSM College (2025). Feel free to ask me about his education, skills, or projects!`;
        }
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    if (spaceshipContainer && spaceship) {
        window.oldScroll = window.scrollY;

        // Particle system for engine sparks
        function createSpark() {
            if (!engineGlow) return;
            const spark = document.createElement('div');
            spark.className = 'engine-spark';
            ...
            spark.style.left = `calc(50% + ${xOffset}px)`;
            spark.style.animation = `spark-fade ${duration}s ease-out forwards`;

            engineGlow.appendChild(spark);
        ...
        window.addEventListener('scroll', function () {
            ...
            // Show/hide spaceship based on scroll position
            if (window.scrollY > 50) {
                spaceshipContainer.classList.add('show');
            } else {
                spaceshipContainer.classList.remove('show');
            }

            // Smooth vertical movement trace: From top (0vh) to bottom (100vh)
            const moveY = scrollPercent * 100;
            const moveX = Math.sin(scrollPercent * Math.PI * 3) * 20;

            spaceshipContainer.style.transform = `translateY(calc(${moveY}vh - ${scrollPercent * 100}%)) translateX(${moveX}px)`;

            // Rotation and spark creation
            if (scrollPercent > 0.98) {
                // Automatically turn up when reaching the bottom
                spaceship.style.transform = 'rotate(5deg)';
            } else if (Math.abs(window.oldScroll - window.scrollY) > 2) {
                // Create multiple sparks while moving
                for (let i = 0; i < 2; i++) createSpark();

                if (window.oldScroll > window.scrollY) {
                    spaceship.style.transform = 'rotate(5deg)'; // Moving Up
                } else {
                    spaceship.style.transform = 'rotate(175deg)'; // Moving Down
                }
            }
